...
const talks = [
  {
    ...
    link: 'https://www.youtube.com/watch?v=cR901Xmb1-I&feature=youtu.be&t=8370',
    date: 'Aug 30, 2019',
  },
  {
    title: 'VueBLR #15 - Atomic Design using VUE',
    link: 'https://www.youtube.com/watch?v=duaDIM3dJH8',
    date: 'Jun 22, 2019',
  },
  { title: 'Frontend DevHours - Flex your layout muscle', link: '', date: 'Feb 15, 2019' },
  {
    title: "Frontend Syncup - It's time to Ember Up",
    link: 'https://slides.com/ruphaaganesh/ember-intro/fullscreen',
    date: 'May 30, 2019',
  },
  {
    title: 'Frontend DevHours - Fontastic Variable Fonts',
    link: 'https://github.com/ruphaa/variable-fonts-experiment',
    date: 'Jul 19, 2019',
  },
];
